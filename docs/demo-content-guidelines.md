...
Prepared 2026-09-16. These are fictional examples for a community website demonstration, not records of actual PIE membership, scheduled activities or student testimonials.

## Members

- Preserve the four supplied real profiles, Sparlay Khan, Zixuan Gui, Tamara Matijević and Alessio SATURNINO, without inventing additional personal facts or attributing fictional stories to them. Omit contact details, nationality or languages that have not been supplied. General Community member / Active labels for the two new teammates describe their current participation without assigning a specific organizational office.
- Twenty-two fictional members include international students, local welcome support, volunteers and alumni. Together with the four supplied real profiles, the directory has twenty-six members. The four real profiles appear first, with the previous twenty-four profiles retaining their content and relative order.
- Avoid the artificial one-person-per-country pattern. In the full illustrative directory, China and France each have four profiles; India and Morocco each have three; Brazil and Pakistan each have two; Germany, Italy, Japan, Mexico, Senegal, Serbia and Sweden each have one. Alessio's nationality is unspecified. The uneven repetition suggests an ordinary mixed community rather than a collection of country representatives. Fictional-profile counts are a design choice, not a claim about PIE's actual demographic distribution.
...
- Retain existing card structures, type styles, spacing, mobile layouts and event date badges.
- Every added portrait and scene has a distinct generated asset. Do not reuse an event image for an experience, or reuse a portrait for a different fictional person.
- Preserve the first three story background colors and repeat their order for added stories.
- The homepage layout and previews are outside this content expansion.
